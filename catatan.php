...
$result = mysqli_query($conn,"SELECT * FROM Aku");
...
<table data-toggle="table" 
    ...
    <tr>
        ...
        <th class="col-xs-1 text-center" data-field="Bobot" >Bobot</th>
        <th class="col-xs-1 text-center" data-field="Obat" >Obat</th>
        <th class="col-xs-1 text-center" data-field="Catatan" >Catatan</th>
    ...
    <td><a href="edit_catatan.php?No=<?php echo $row['No']; ?>">Edit</a> | <a href="javascript:del(<?php echo $row['No'];?>)">Hapus</a></td>
      </tr>
