...
$result = mysqli_query($conn,"SELECT * FROM Ayam");
...
<html>
 <head>
   <title>Monitoring Ayam BroilerKu</title>
    <meta charset="utf-8">
...
<div class="container-fluid p-5 bg-ligh text-dark text-center">
  <h2>Monitoring Ayam BroilerKu</h2>
</div>
...
<table data-toggle="table" 
    ...
    <tr>
        ...
        <th class="col-xs-1 text-center" data-field="Mati" >Ayam Mati</th>
        <th class="col-xs-1 text-center" data-field="Jual" >Ayam Terjual</th>
        <th class="col-xs-1 text-center" data-field="Kasih" >Ayam Keluar</th>
	  ...
	  <tr>
		...
		<td><?php echo $row["Kasih"]; ?></td>
    <td><a href="edit_ayam.php?No=<?php echo $row['No']; ?>">Edit</a> | <a href="javascript:del(<?php echo $row['No'];?>)">Hapus</a></td>
      </tr>
